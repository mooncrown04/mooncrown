...
ULUSAL_ORDER = ["TRT 1", "SHOW TV", "ATV", "KANAL D", "STAR", "NOW", "KANAL 7", "TV 8", "TV 8.5", "BEYAZ", "TEVE 2", "A2", "TELE 1", "SHOWTURK"]
HABER_ORDER = ["HALK TV", "SÖZCÜ TV", "CNN TÜRK", "TV 100", "SÖZCÜ TV","NTV", "Flash Haber TV", "HABER GLOBAL", "TGRT HABER", "TV 24", "ÜLKE TV","NEO HABER"]
SPOR_ORDER = ["BEIN SPORTS 1","HT SPOR","TIVIBU SPOR","SPOR","TRT 3 SPOR","","TARAFTAR", "A SPOR", "S SPORT","FUTBOL TV","TRT SPOR"]
BELGESEL_ORDER = ["NATGEO CHANNEL","NAT GEO WILD","TLC", "NEO HABER","PERSIANA TURKIYE","DMAX","CGTN BELGESEL", "BELGESEL TV"],
MÜZİK_ORDER = ["KRAL POP TV","POWERTÜRK TV","POWER TV", "NUMBER ONE TURK","NUMBER 1 DAMAR","MED MUZIK"],
